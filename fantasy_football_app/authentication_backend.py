...
from fantasy_football_app import settings
from fantasy_football_app.authentication_token import TokenUser
...
class JWTAccessTokenAuthentication(authentication.BaseAuthentication):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if jwks_client:
            ...
            self.jwks_client = PyJWKClient(settings.OAUTH2_TENANT_JWKS)
    ...
    def authenticate(self, request: HttpRequest):
        ...
        options = None
        extra_params = {"algorithms": ["RS256"], "audience": settings.OAUTH2_AUDIENCE}
