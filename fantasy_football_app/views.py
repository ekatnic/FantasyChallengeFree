...
from .serializers import CognitoAuthSerializer

class CognitoLoginApi(APIView):
    def get(self, request, *args, **kwargs):
        print(f"Cognitologin Api: {request.GET}")

        auth_serializer = CognitoAuthSerializer(data=request.GET)
